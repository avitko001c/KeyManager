...
class TestFolders(BaseTest):
    ...
    def setUp(self):
        ...
        self.create_urlname = "documents:folder_create"
        self.detail_urlname = "documents:folder_detail"
        self.share_urlname = "documents:folder_share"
        self.delete_urlname = "documents:folder_delete"
    ...
    def test_delete_recursive(self, mock_messages):
        ...
        with self.login(self.user):
            ...
            response = self.get("documents:document_detail", pk=child_document.pk)
            self.response_404(response)
            response = self.get("documents:document_detail", pk=grand_child_document.pk)
            self.response_404(response)
...
class TestDocuments(BaseTest):
    ...
    def setUp(self):
        ...
        self.create_urlname = "documents:document_create"
        self.detail_urlname = "documents:document_detail"
        self.download_urlname = "documents:document_download"
    ...
    def test_valid_delete(self, mock_messages):
        ...
        with self.login(self.user):
            ...
            response = self.post("documents:document_delete", pk=doc_pk, follow=True)
            self.response_200(response)
